...
const devicesId = "643810329" // 填写在OneNet上获得的devicesId 形式就是一串数字 
const api_key = "uW31uFo0k9DeIwIIAjO8ahAb=sU=" // 填写在OneNet上的 api-key 
...
Page({
  ...
  convert: function (datapoints) {
    ...
    var humiditynew=humidity[humidity.length-1];//将数组中最后一个数据放进设置的data
    var tempenew=tempe[tempt.length-1];
    that.setData({
